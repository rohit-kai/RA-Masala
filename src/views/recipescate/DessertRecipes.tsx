...
const DessertRecipes: React.FC = () => {
  const { t } = useLanguage();
  const recipes = [
    {
      id: "de1",
      title: "Shahi Cardamom Kheer",
      description: "Rich, slow-cooked rice pudding infused with saffron, almonds, and aromatic cardamom powder.",
      image: getAssetPath('images/recipes3.png'),
      youtubeUrl: "https://www.youtube.com/shorts/ygH3GRb4W7s?si=b2-jnV-fOXVvSvh8",
  ...
  return (
    <div style={{ backgroundColor: '#FDF6ED', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <Header />
      <Banner page={t('rcp_dessert_recipes')} path={[t('nav_home'), t('rcp_title'), t('rcp_cat_dessert')]} />
