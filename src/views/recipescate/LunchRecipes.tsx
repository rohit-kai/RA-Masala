...
const LunchRecipes: React.FC = () => {
  const { t } = useLanguage();
  const recipes = [
    {
      id: "l1",
      title: "Kolhapuri Misal Pav",
      description: "A fiery sprouted moth bean curry topped with crispy namkeen mix and fresh onions, served with buttered pav.",
  ...
  return (
    <div style={{ backgroundColor: '#FDF6ED', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <Header />
      <Banner page={t('rcp_lunch_recipes')} path={[t('nav_home'), t('rcp_title'), t('rcp_cat_lunch')]} />
