...
const FestiveRecipes: React.FC = () => {
  const { t } = useLanguage();
  const recipes = [
    {
      id: "f1",
      title: "Traditional Puran Poli",
      description: "A sweet Maharashtrian flatbread stuffed with sweet lentil filling, roasted on a griddle with ghee.",
  ...
  return (
    <div style={{ backgroundColor: '#FDF6ED', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <Header />
      <Banner page={t('rcp_festive_recipes')} path={[t('nav_home'), t('rcp_title'), t('rcp_cat_festive')]} />
